...
hi Visual ctermfg=NONE ctermbg=60 cterm=NONE guifg=NONE guibg=#161a1f gui=NONE
hi CursorLine ctermfg=NONE ctermbg=black cterm=NONE guifg=NONE guibg=#404b4d gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=black cterm=NONE guifg=NONE guibg=#404b4d gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=black cterm=NONE guifg=NONE guibg=#404b4d gui=NONE
hi LineNr ctermfg=102 ctermbg=black cterm=NONE guifg=#78898c guibg=#404b4d gui=NONE
hi VertSplit ctermfg=black ctermbg=black cterm=NONE guifg=#5a686b guibg=#5a686b gui=NONE
hi MatchParen ctermfg=153 ctermbg=60 cterm=NONE guifg=#b1e2f2 guibg=NONE gui=NONE
hi StatusLine ctermfg=152 ctermbg=black cterm=bold guifg=#bdd6db guibg=#5a686b gui=bold
hi StatusLineNC ctermfg=152 ctermbg=black cterm=NONE guifg=#bdd6db guibg=#5a686b gui=NONE
...
hi Folded ctermfg=60 ctermbg=black cterm=NONE guifg=#537178 guibg=#323b3d gui=NONE

hi Normal ctermfg=152 ctermbg=black cterm=NONE guifg=#bdd6db guibg=#323b3d gui=NONE
...
hi NonText ctermfg=black ctermbg=black cterm=NONE guifg=#3b3a32 guibg=#394345 gui=NONE
...
hi SpecialKey ctermfg=black ctermbg=black cterm=NONE guifg=#3b3a32 guibg=#404b4d gui=NONE
...
hi javaScriptBraces ctermfg=75 ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
